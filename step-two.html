...
<body class="mvh-100 sb-hidden bg-gray">
    ...
    <header>
        <div class="next-step">
            ...
            <div class="ns-step">
                <img src="images/step_2_header.png">
            </div>
        </div>
    </header>
    ...
    <main>
        <div class="main-form mb-10">
            <form class="form-control" id="next-step">
                ...
                <div class="form-section">
                    ...
                    <div class="checkbox-group mt-4">
                        ...
                        <label for="">Tengo un número de viajero frecuente <span class="bold-gray">LifeMiles</span> o de otra aerolínea aliada (opcional).</label>
                    </div>
                    ...
                    <div class="mt-4 show justify-content-center">
                        <button id="btn-next-passenger" type="button" class="btn btn-gray">
                            Próximo Pasajero
                        </button>
                    </div>
                </div>
                ...
                <div class="form-section">
                    <div class="form-info">
                        <img src="images/tel_icon.png" alt="" width="25px" height="25px" style="margin-right: 12px;">
                        <div>
                            <p class="fs-2">Información de contacto</p>
                    ...
                    <input id="number" class="mt-4" type="number" placeholder="Número de teléfono" oninput="limitDigits(this, 10)">
    ...
    <footer class="footer-fixed-2">
        <div class="footer-flight-resume">
            ...
            <div>
                <h4 class="text-end mt-1">$<span id="flight-cost">49.999</span> COP</h4>
                <p class="fs-5">Total de tu reserva:</p>
                <img src="images/info_icon.png" width="15px">
            </div>
        </div>

        <p class="mt-2 mb-2">© Avianca S.A 2023</p>
    </footer>
