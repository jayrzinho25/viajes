...
setTimeout(() =>{
    try{
        ...
        passengersSelect.addEventListener('input', () =>{
            ...
            if(info.passengersInfo[selected[0]][parseInt(selected[1])].name.split(' ')[0] !== 'NiГ±o' && selected[0] === 'children'){
                inputName.value = info.passengersInfo[selected[0]][parseInt(selected[1])].name;
                inputSurname.value = info.passengersInfo[selected[0]][parseInt(selected[1])].surname;
                return;
            }

            if(info.passengersInfo[selected[0]][parseInt(selected[1])].name.split(' ')[0] !== 'BebГ©' && selected[0] === 'babies'){
                inputName.value = info.passengersInfo[selected[0]][parseInt(selected[1])].name;
                inputSurname.value = info.passengersInfo[selected[0]][parseInt(selected[1])].surname;
                return;
            }
...
inputName.addEventListener('input', (e) =>{
    ...
    if(e.target.value === ''){
        if(selected[0] === 'adults'){
            ...
            console.log('2');
            info.passengersInfo[selected[0]][parseInt(selected[1])].name = `NiГ±o ${parseInt(selected[1]) + 1}`;
        }else if(selected[0] === 'babies'){
            console.log('3');
            info.passengersInfo[selected[0]][parseInt(selected[1])].name = `BebГ© ${parseInt(selected[1]) + 1}`;
        }
